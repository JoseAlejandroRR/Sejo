...
public class DB{
    ...
    protected boolean openConnection()
    {
        ...
        try{
            //System.out.printf("Conetando %s %s %s\n",user, pass, url);
    ...
    public boolean executeRequest(String sql, Map<String, String> params)
    {
        ...
        try{
            ...
            while(itte.hasNext())
            {
                ...
                n++;
				/*switch(pmd.getParameterType(n))
				{

				}*/
            }
            //sql = sql.replaceFirst("[?]", "ALGO");
            this.requestSQL = sql;
            ...
            if(evaluate.contains("select")){
				...
				/*if(this.loadRequest(sql) || false){
					this.showConsole("-- LOADREQUEST --\n");
					this.data = this.requestReader();
					this.showConsole("-- ENDLOADREQUEST --\n");
				} else {
