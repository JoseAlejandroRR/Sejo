...
public class NotificationDB implements NotificationDBListener {
	...
	public void addEventListener(NotificationDBListener listener)
	{
	...
	private void triggerChecksumEvent() {
        ...
        while (li.hasNext()) {
            NotificationDBListener listener = (NotificationDBListener) li.next();
            NotificationDBEvent readerEvObj = new NotificationDBEvent(this, this);
            (listener).onChecksumChange(readerEvObj);
        }
    }
	
	@Override
	public void onChecksumChange(NotificationDBEvent ev) {
